...
public:
    SimpleKalmanFilter(double process_noise,double measurement_noise,double estimation_error,double initial_value){ //covariance

    R = measurement_noise;
    Q = process_noise;
    P = estimation_error; //prediction error
    X = initial_value;
}
